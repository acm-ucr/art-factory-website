    ...
    <div className="flex justify-center pt-3">
      ...
      <div className="absolute z-10 flex items-center top-[19%] md:top-[45%] 2xl:top-[40%] justify-center px-8">
        <Image
          src={leftcurve}
          alt="leftring"
          className="absolute left-[4%] md:-left-[3%] top-[66%] md:top-[80%] w-28 md:w-64 rotate-2 md:rotate-5"
        />

        <div className="text-white font-lora text-2xl md:text-6xl tracking-[10px] md:tracking-[25px] drop-shadow-xl font-bold p-1">
          art factory
        </div>
