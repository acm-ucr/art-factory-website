  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <p className="text-lg mb-2 mt-8 mx-4 sm:mx-10 md:mx-20 lg:mx-40 xl:mx-80 text-center">
        ...
        of 2023, and our name, "Art Factory," embodies our commitment to being a
        vibrant community of artists with a vision to cultivate creativity and
        exploration across various art genres. We aim to provide a space where
        members can freely experiment, collaborate, and express themselves
        artistically.{" "}
      </p>
      ...
      <p className="text-lg my-8 mx-4 sm:mx-10 md:mx-20 lg:mx-40 xl:mx-80 text-center">
        ...
        music. It’s designed to make you all feel relaxed. If you come to our
        meeting, I can guarantee that you are bound to like at least one thing.{" "}
      </p>
