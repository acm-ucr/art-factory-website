  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <p className="text-lg my-8 mx-4 sm:mx-10 md:mx-20 lg:mx-40 xl:mx-80 text-center">
        {
          'Welcome to Art Factory at UCR! The organization was established in the\
        spring quarter of 2023, and our name, "Art Factory," embodies our\
        ...
        to provide a space where members can freely experiment, collaborate, and\
