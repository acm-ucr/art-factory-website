...
const Board = ({ name, title, image, custom }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-[90%] border-[3px] md:border-[6.5px] border-art-purple-200 rounded-full py-[3.75px] md:py-0 px-[4px] md:px-1 drop-shadow-[4px_5px_0px_rgba(205,164,229,255)]">
